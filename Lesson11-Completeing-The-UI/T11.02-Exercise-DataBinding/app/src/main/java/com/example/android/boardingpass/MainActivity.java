...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long hoursRemovedMinUntilBoarding = totalMinUntilBoarding -
                TimeUnit.HOURS.toMinutes(hoursUntilBoarding);
//        String timeUntilBoardingDisplay = hoursUntilBoarding + ":" + hoursRemovedMinUntilBoarding;
        String timeUntilBoardingDisplay = getString(R.string.countDownFormat, hoursUntilBoarding,
                hoursRemovedMinUntilBoarding);
        mBinding.textViewBoardingInCountdown.setText(timeUntilBoardingDisplay);
