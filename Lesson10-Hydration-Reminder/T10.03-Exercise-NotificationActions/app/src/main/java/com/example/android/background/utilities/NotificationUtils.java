...
//    private static final int WATER_REMINDER_DISMISS_ID = 1234;

//    private static final int WATER_REMINDER_SIPPY_ID = 1234;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context){
        Intent launchWaterReminderService = new Intent(context, WaterReminderIntentService.class);
        launchWaterReminderService.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
        PendingIntent waterReminderServicePendingIntent =
                PendingIntent.getService(
                        context,
                        WATER_REMINDER_PENDING_INTENT_ID,
                        launchWaterReminderService,
                        PendingIntent.FLAG_UPDATE_CURRENT);

        NotificationCompat.Action dismissReminderAction =
                new NotificationCompat.Action(
                        R.drawable.ic_cancel_black_24px,
                        "NAH",
                        waterReminderServicePendingIntent
                        );
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        Intent launchWaterReminderService = new Intent(context, WaterReminderIntentService.class);
        launchWaterReminderService.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        PendingIntent waterReminderServicePendingIntent =
                PendingIntent.getService(
                        context,
                        WATER_REMINDER_PENDING_INTENT_ID,
