...
public class NotificationUtils {
    ...
    private static final int PENDING_INTENT_ID = 420;
    private static final int REMINDER_ID = 421;
    ...
    public static void remindUserBecauseCharging(Context context){
        String notificationBody = context.getString(R.string.charging_reminder_notification_body);
        String notificationTitle = context.getString(R.string.charging_reminder_notification_title);
        ...
        notificationManager.notify(REMINDER_ID , mBuilder.build());
    ...
    private static Bitmap largeIcon(Context context){
        ...
        int iconID = R.drawable.ic_local_drink_black_24px;
