...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent waterReminderTaskIntent = new Intent(this, WaterReminderIntentService.class);
        // DONE (16) Set the action of the intent to ACTION_INCREMENT_WATER_COUNT
        waterReminderTaskIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        // DONE (17) Call startService and pass the explicit intent you just created
        startService(waterReminderTaskIntent);
    }
