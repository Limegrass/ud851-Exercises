...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        super.onResume();
        this.registerReceiver(mChargingBroadcastReceiver, mChargingIntentFilter);
    }
    ...
    protected void onPause() {
        super.onPause();
        this.unregisterReceiver(mChargingBroadcastReceiver);
    }
    ...
    private void showCharging(boolean deviceIsCharging){
        if(deviceIsCharging){
            mChargingImageView.setImageResource(R.drawable.ic_power_pink_80px);
        }
        else{
            mChargingImageView.setImageResource(R.drawable.ic_cancel_black_24px);
        }
    ...
    private class ChargingBroadcastReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            //True if charging, else if not.
            boolean deviceIsCharging = (intent.getAction().equals(Intent.ACTION_POWER_CONNECTED));
            showCharging(deviceIsCharging);
        }
    }
