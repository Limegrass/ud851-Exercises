...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        if( (mNewGuestNameEditText == null) || (mNewGuestNameEditText.getText().toString() == "") ||
                (mNewPartySizeEditText == null) || (mNewPartySizeEditText.getText().toString() == "") ){
            return;
        }
        ...
        try{
            ...
            Log.d(LOG_TAG, "addToWaitlist: Party size not a number.");
            return;
        }
