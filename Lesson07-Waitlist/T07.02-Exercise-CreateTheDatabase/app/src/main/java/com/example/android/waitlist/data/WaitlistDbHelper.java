...
public class WaitlistDbHelper extends SQLiteOpenHelper {
    ...
    // TODO (3) Create a static final int caled DATABASE_VERSION and set it to 1
    private static final int DATABASE_VERSION = 1;

    // TODO (4) Create a Constructor that takesl a context and calls the parent constructor
