...
public class MainActivity extends AppCompatActivity {
    ...
    private Cursor getAllGuests(){
        String table = WaitlistContract.WaitlistEntry.TABLE_NAME;
        String orderBy = WaitlistContract.WaitlistEntry.COLUMN_TIMESTAMP;
        // columns = null selects all columns, selection = null selects all rows
        // group = null is no grouping, having = null all row groups included
        String[] columns = null, selectionArgs = null;
        String groupBy = null, having = null, selection = null;
