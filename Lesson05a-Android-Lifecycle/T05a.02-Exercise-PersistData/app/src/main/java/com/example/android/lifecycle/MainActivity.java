...
public class MainActivity extends AppCompatActivity {
    ...
    // CTODO (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // CTODO (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView
    ...
    // CTODO (2) Override onSaveInstanceState
    ...
    // CTODO (3) Call super.onSaveInstanceState
    // CTODO (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
    // CTODO (5) Put the text from the TextView in the outState bundle
