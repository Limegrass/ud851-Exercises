...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadSizeFromPreferences(SharedPreferences sharedPreferences){
        String sizePreferenceString = sharedPreferences.getString(getString(R.string.pref_size_key),
                getString(R.string.pref_size_default));
        if (sizePreferenceString.equals("")){
            sizePreferenceString = getString(R.string.pref_size_default);
        }
        Float sizePreference = Float.parseFloat(sizePreferenceString);
        mVisualizerView.setMinSizeScale(sizePreference);
    }
