...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupColor(SharedPreferences sharedPreferences){
        String defaultColor = getString(R.string.pref_color_red_value);
        String preferredColor = sharedPreferences.getString(getString(R.string.pref_color_key), defaultColor);
        mVisualizerView.setColor(preferredColor);
    }
